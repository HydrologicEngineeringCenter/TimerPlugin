 ...
 * @author WatPowerUser
 */
public class TimerAlternativeFactory extends AbstractNewObjectFactory  implements NewObjectFactory{
    private TimerPlugin _plugin;
    public TimerAlternativeFactory(TimerPlugin plugin){
        super(TimerPluginI18n.getI18n(TimerPluginMessages.Bundle_Name));
        _plugin = plugin;
    }
    @Override
    ...
    public Object createObject(JComponent jc) {
        ...
        TimerAlternative alt = new TimerAlternative();
